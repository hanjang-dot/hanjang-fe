...
const buildChoices = (texts: string[]) =>
  ...
  "exam-2025-suneung-korean": [
    {
      ...
      correctChoiceId: "사실과 주장을 구분하는 비판적 읽기가 필요하다",
    },
    {
      questionId: "q-kor-2",
      number: 2,
      ...
      correctChoiceId: "전통 시장이 담고 있는 공동체적 관계",
    },
  ],
  "exam-2025-sep-english": [
    {
      ...
      correctChoiceId: "독서는 다양한 관점을 접하게 해 준다",
    },
  ],
  "exam-2024-suneung-math": [
    {
      ...
      prompt: "f(x)의 최솟값은?",
      choices: buildChoices(["-2", "-1", "0", "1", "3"]),
      correctChoiceId: "-1",
    },
  ],
};
